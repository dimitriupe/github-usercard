...
axios.get('https://api.github.com/users/dimitriupe')
...
followersArray.forEach(person => {
  axios.get('https://api.github.com/users/' + person).then(data => {
  document.querySelector('.cards').appendChild(cardCreator(data));
  })
  .catch(err => console.log(err));
});

// followersArray.forEach(lsInstructor => {
//   axios.get("https://api.github.com/users/" + lsInstructor.login)
//     .then( response => {
//       console.log(response.data);
//       cards.appendChild(cardCreator(response.data));
//     });
